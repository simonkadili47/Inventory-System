      ...
      <div class="row">
        <div class="col-lg-8">
          ...
          <div class="form-group">
            ...
            <input type="text" id="productName" name="product_name" class="form-control custom-input-width" value= "{{$product->product_name}}"required>
          </div>
          <div class="form-group">
            <label for="productDescription">Product Description</label>
            <input type="text" id="productDescription" name="product_description" class="form-control custom-input-width" value= "{{$product->product_description}}" required>
          </div>
          <div class="form-group">
            <label for="productCategory">Product Category</label>
            <select id="Category_id" name="category_id" class="form-control custom-input-width" required>
          ...
          <div class="form-group">
            ...
            <input type="number" id="quantity" name="quantity" class="form-control custom-input-width" value= "{{$product->quantity}}" required>
          </div>
          <div class="form-group">
            <label for="buyingPrice">Buying Price</label>
            <input type="number" id="buyingPrice" name="buying_price" class="form-control custom-input-width" value= "{{$product->buying_price}}" required>
          </div>
          <div class="form-group">
            <label for="sellingPrice">Selling Price</label>
            <input type="number" id="sellingPrice" name="selling_price" class="form-control custom-input-width" value= "{{$product->selling_price}}" required>
          </div>
          <!-- <div class="form-group">
            <label for="totalPrice">Total Price</label>
            <input type="number" id="totalPrice" name="total_price" class="form-control custom-input-width" required>
            </div> -->

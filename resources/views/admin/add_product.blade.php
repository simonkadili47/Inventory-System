...
<header class="header">   
  <nav class="navbar navbar-expand-lg">
    <div class="container-fluid d-flex align-items-center justify-content-between">
      ...
      <!-- Log out -->
      <div class="list-inline-item logout btn btn-success">
      ...
      <div class="form-container">
        ...
        <form action="{{ url('add_product') }}" method="post">
          ...
          <div class="form-group">
            ...
            <input type="text" id="productName" name="product_name" class="form-control custom-input-width" required>
          </div>
          <div class="form-group">
            <label for="productDescription">Product Description</label>
            <input type="text" id="productDescription" name="product_description" class="form-control custom-input-width" required>
          </div>
          <div class="form-group">
            <label for="productCategory">Product Category</label>
            <select id="Category_id" name="category_id" class="form-control custom-input-width" required>
              <option value="" disabled selected>Select a category</option>
              @foreach($category as $category) <!-- Changed variable name to $categories -->
          ...
          <div class="form-group">
            ...
            <input type="number" id="buyingPrice" name="buying_price" class="form-control custom-input-width" required>
          </div>
          <div class="form-group">
            <label for="sellingPrice">Selling Price</label>
            <input type="number" id="sellingPrice" name="selling_price" class="form-control custom-input-width" required>
          </div>
          <!-- <div class="form-group">

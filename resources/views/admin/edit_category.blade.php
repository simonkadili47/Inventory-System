            ...
            <div class="card-body">
              <form action="{{ url('update_category', $data->id) }}" method="POST">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="categoryName" name="category_name" value="{{ $data->category_name }}" required>
                </div>
                <div class="form-group">
                  <label for="categoryDescription">Category Description</label>
                  <textarea class="form-control" id="categoryDescription" name="category_description" rows="4" required>{{ $data->category_description }}</textarea>
                </div>

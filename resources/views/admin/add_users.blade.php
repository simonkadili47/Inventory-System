        ...
        <div class="form-container">
          ...
          <form action="{{url('add_users')}}" method="post">
            ...
            <div class="form-group">
              ...
              <input type="text" id="Name" name="name" class="form-control custom-input-width" required>
            </div>
          
            <div class="form-group">
              <label for="Email"> Email</label>
              <input type="text" id="Email" name="email" class="form-control custom-input-width" required>
            </div>
            <div class="form-group">
            <label for="userType">Usertype</label>
            <select id="usertype" name="usertype" class="form-control custom-input-width" required>
            <option value="" disabled selected>Select a usertype</option>
            ...
            <div class="form-group">
              ...
              <input type="password" id="password" name="password" class="form-control custom-input-width" required>
            </div>
            <div class="form-group">
              <label for="ConfirmPassword"> Confirm Password</label>
              <input type="password" id="confirmPassword" name="remember_token" class="form-control custom-input-width" required>
            </div>

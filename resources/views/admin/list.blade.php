...
<head>
  ...
  <style>
    ...
    .table {
      width: 80%; /* Adjust the overall table width as needed */
      margin-bottom: 1rem;
      color: #212529;
    ...
    .table tbody td {
      color: black; /* White text color for table data */
    }
    .table tbody + tbody {
  ...
  <nav id="sidebar">
    <ul class="list-unstyled">
      ...
      <!-- <li>
        ...
        <li><a href="view_sales">Add Sales</a></li>
          <li><a href="list_sales">Sales List</a></li>
        </ul>
      </li>
      <li>
    ...
    <div class="page-header">
      <div class="container-fluid">
        ...
        <div class="table-title-container">
          <h3>Category List</h3>
          <a href="{{url('view_category')}}" class="btn btn-primary">Add Category</a>
        </div>

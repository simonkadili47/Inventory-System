    ...
    <div class="page-header">
      <div class="container-fluid">
        ...
        <div class="table-title-container">
          <h3>Sales List</h3>
          <a href="{{url('print_sales')}}" class="btn btn-primary">Print Sales report</a>
        </div>
      </div>
    </div>
    <div class="container-fluid">
    ...
    <div class="table-responsive">
        <table class="table table-striped">
            ...
            @foreach($reports as $report)
                <tr>
                    <!-- <td>{{ $sale->id }}</td> -->
                    <td>{{ $reports->sales->date }}</td>
                    <td>{{ $reports->sales->customer_name }}</td>
                    <td>{{ $reports->sales->product->product_name }}</td>
                    <td>{{ $reports->sales->quantity }}</td>
                    <td>{{ $reports->sales->total_price }}</td>
                    <td>{{ $reports->sales->profit }}</td>
            

                </tr>
                    <td>
                        <a href="{{ url('print_pdf', $reports->id) }}" class="btn btn-danger" onClick="Confirmation(event)">Pdf</a>
                        <a href="{{ url('export_excel', $reports->id) }}" class="btn btn-success">Excel</a>
                    </td>
                </tr>
                @endforeach
